...
describe("GameUtils", () => {
  ...
  describe("isUnmarked", () => {
    it("should return true if column is unmarked", () => {
      expect(
        isUnmarked({ row: 0, column: 0, filledWith: Marker.unmarked })
      ).toBeTruthy();
    });

    it("should return false if column is filled with heart", () => {
      expect(
        isUnmarked({ row: 0, column: 0, filledWith: Marker.heart })
      ).toBeFalsy();
    });

    it("should return false if column is filled with heart", () => {
      expect(
        isUnmarked({ row: 0, column: 0, filledWith: Marker.cross })
      ).toBeFalsy();
    });
  });
